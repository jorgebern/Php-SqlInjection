            ...
            <!-------Cuerpo------>
                  <div id="cuerpo">
                        ...
                        <form action="validarAgenda.php" method="post">
                              <p>Usuario <input id="text" type="text" name="usuario"></p>
                              <p>Constrase&ntilde;a <input type="password" name="password"></p>
                              <p> <input type="reset" name="borrar" value="Borrar"> 
