...
<html>
  ...
  <!---- Contenerdor------>
      <div id="contenedor">
            ...
            <p>Direcci&oacute;n: <input type="text" name="Direccion"></p>
            <p>C&oacute;digo postal: <input type="text" name="Codigopostal"></p>
            <p>Localidad: <input type="text" name="Localidad"></p>
            <p>Provincia <input type="text" name="Provincia"></p>
            <p>Otros:</p><p> <textarea></textarea></p>
            <p> <input type="button" name="alta" value="Dar de Alta">
